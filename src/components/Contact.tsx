            ...
            <div className="contact-info-card" style={{ height: '100%' }}>
              ...
              <div className="contact-detail-item">
                ...
                <div>
                  ...
                  <p style={{ fontSize: '0.9rem', color: '#64748B' }}>fahad.resumespecialist@gmail.com</p>
              ...
              <div className="contact-detail-item">
                ...
                <div>
                  ...
                  <a href="https://linkedin.com/in/fahad-resumespecialist" target="_blank" rel="noopener noreferrer" style={{ fontSize: '0.9rem', color: '#2563EB', fontWeight: 600 }}>
                    linkedin.com/in/fahad-resumespecialist
                  </a>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="Mid-Level">Mid-Level / Specialist (3-7 yrs)</option>
                        <option value="Senior Management">Senior Manager / Director (8+ yrs)</option>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Full Career Rebranding Bundle">Full Career Rebranding Bundle</option>
                    </select>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      placeholder="Briefly describe your target role, industry, or key challenges..."
                  ...
                  <button type="submit" className="btn btn-primary btn-lg" style={{ width: '100%', marginTop: '0.5rem' }}>
                    <Send size={18} />
                    <span>Send Inquiry to {displayName}</span>
                  </button>

                  <p style={{ fontSize: '0.75rem', color: '#94A3B8', textAlign: 'center', marginTop: '0.25rem' }}>
                    🔒 100% Privacy Protected. No spam or aggressive marketing calls.
                  </p>
                </form>
              )}
